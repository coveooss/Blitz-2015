...
DimensionFilter = module.exports.DimensionFilter = function(args) {
  this.dimension = null;
  this.value = null;
  if (args) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem48 = null;
          elem48 = new ttypes.DimensionFilter();
          elem48.read(input);
